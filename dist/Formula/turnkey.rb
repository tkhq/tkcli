class Turnkey < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/tkhq/tkcli/raw/2023.04.28/dist/turnkey.darwin-aarch64", using: CurlDownloadStrategy
  ...
  if Hardware::CPU.intel?
    url "https://github.com/tkhq/tkcli/raw/2023.04.28/dist/turnkey.darwin-x86_64", using: CurlDownloadStrategy
