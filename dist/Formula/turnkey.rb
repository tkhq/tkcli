class Turnkey < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/tkhq/tkcli/raw/1.0.0/dist/turnkey.darwin-aarch64", using: CurlDownloadStrategy
  ...
  if Hardware::CPU.intel?
    url "https://github.com/tkhq/tkcli/raw/1.0.0/dist/turnkey.darwin-x86_64", using: CurlDownloadStrategy
