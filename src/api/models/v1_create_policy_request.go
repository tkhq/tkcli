...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ACTIVITY_TYPE_CREATE_POLICY"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// V1CreatePolicyRequestTypeACTIVITYTYPECREATEPOLICY captures enum value "ACTIVITY_TYPE_CREATE_POLICY"
	V1CreatePolicyRequestTypeACTIVITYTYPECREATEPOLICY string = "ACTIVITY_TYPE_CREATE_POLICY"
)
