...
func init() {
	...
	walletExportCmd.Flags().StringVar(&targetPublicKeyPath, "target-public-key-path", "", "filepath to read the target public key generated by `generate encryption-key`.")
	walletExportCmd.Flags().StringVar(&exportBundlePath, "export-bundle-path", "", "filepath to write the export bundle to.")
