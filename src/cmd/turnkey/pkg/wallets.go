...
func init() {
	...
	walletInitImportCmd.Flags().StringVar(&walletUserID, "name", "", "ID of user to importing the wallet")
	...
	walletImportCmd.Flags().StringVar(&walletUserID, "name", "", "ID of user to importing the wallet")
