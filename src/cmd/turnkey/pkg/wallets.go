...
func init() {
	...
	walletExportCmd.Flags().StringVar(&TargetPublicKeyPath, "target-public-key-path", "/target_public_key.txt", "filepath to read the target public key generated by `generate encryption-key`.")
	walletExportCmd.Flags().StringVar(&ExportBundlePath, "export-bundle-path", "/export_bundle.txt", "filepath to write the export bundle to.")

	walletInitImportCmd.Flags().StringVar(&User, "user", "", "ID of user to importing the wallet")
	walletInitImportCmd.Flags().StringVar(&ImportBundlePath, "import-bundle-path", "/import_bundle.txt", "filepath to write the import bundle to.")
	...
	walletInitImportCmd.Flags().StringVar(&EncryptedBundlePath, "encrypted-bundle-path", "/encrypted_bundle.txt", "filepath to read the encrypted bundle from.")
