...
func init() {
	...
	privateKeyInitImportCmd.Flags().StringVar(&privateKeyUserID, "user", "", "ID of user to importing the private key")
	...
	privateKeyImportCmd.Flags().StringVar(&privateKeyUserID, "user", "", "ID of user to importing the private key")
